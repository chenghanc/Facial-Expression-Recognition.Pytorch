...
A CNN based pytorch implementation on facial expression recognition (FER2013 and CK+), achieving 73.112% (state-of-the-art) in FER2013 and **94.848%** in CK+ dataset
...
###      CK+ Accurary      ###
- Model：    VGG19 ;       Test_acc：   **94.848%** (Hardswish)   <Br/>
